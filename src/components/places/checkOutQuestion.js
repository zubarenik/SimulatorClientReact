    ...
    return (
        ...
        <>
            <Form className='auth-login-form mt-2' onSubmit={save}>
                ...
                <FormGroup>
                    <Label for="postreply_text">Комментарий для верного выбора</Label>
                    <Tiny
                        id="postreply_text"
                ...
                <FormGroup>
                    <Label for="postreply_female_text">Комментарий для верного выбора (жен)</Label>
                    <Tiny
                ...
                <FormGroup>
                    <Label for="postreply_error_text">Комментарий для неверного выбора</Label>
                    <Tiny
                ...
                <FormGroup>
                    <Label for="postreply_error_female_text">Комментарий для неверного выбора (жен)</Label>
                    <Tiny
                ...
                <FormGroup>
                    <Input
                        value={form.award}
                        label="Награда для верного выбора"
                        onChange={changeHandler}
                        type='number'
                        id='login-award'
                        name="award"
                ...
                <FormGroup>
                    <Input
                        value={form.award_error}
                        label="Награда для неверного выбора"
                        onChange={changeHandler}
                        type='number'
                        id='login-award-error'
                        name="award_error"
                        placeholder='' />
                </FormGroup>
                <FormGroup>
